...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var linearlayoutPaintColor = findViewById<LinearLayout>(R.id.ll_paint_colors)
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            showRationaleDialog("AAAAA", " Need access external storage")
        } else {
    ...
    private fun getBitmapFromView(view: View): Bitmap {
        val returnnedBitmap = Bitmap.createBitmap(view.width, view.height, Bitmap.Config.ARGB_8888)
        val canvas = Canvas(returnnedBitmap)
                ...
                try {
                    ...
                    runOnUiThread {
                        ...
                        if (result.isNotEmpty()) {
                            Toast.makeText(this@MainActivity, "file saved", Toast.LENGTH_LONG)
                                .show()
                            shareImage(result)
                        } else {
                            Toast.makeText(
